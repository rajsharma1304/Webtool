...
var validator = {
    ...
    checkAirlineInputs: function (index, airlineChild, messages, ctrls, cards) {
        ...
        if (me.invalidValue === airlineId) {
            ...
            aServerObject.OriginId = airlineOption.attr('originId'),
        ...
        if (me.invalidValue === destinationId) {
            ...
            isAnySelected = true;
            var chosenId = me.isEditing ? $('#EditedAirportList').val() : $('#AirportList').val();                
            aServerObject.DestinationId = isDeparture ? destinationId : chosenId;
        }
    ...
    checkAirlines: function () {
        ...
        console.log(me.airlineData.dict);
